                    ...
                    <div class="row-fluid">
                        ...
                        <section id="formElement" class="utopia-widget utopia-form-box section">
                            <div class="utopia-widget-title">
                                ...
                                <span>Select/De-Select Group Members</span>
                            </div>
                            ...
                            <div class="row-fluid">
                                <div class="utopia-widget-content">
                                    ...
                                    <html:form styleClass="form-horizontal" action="/ManageGroups.do?callmethod=editUserList" method="post"  >
                                        <fieldset>
                                      <div class="row-fluid" >      
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="row-fluid">
                                    <html:link styleClass="btn jumbo"  page="/ManageGroups.do?callmethod=getGroupList">
