                    ...
                    <div class="row-fluid">
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="utopia-widget-content" style="display: block;">
                                ...
                                <html:form action="/EvaluateAssignmentStudent.do?callmethod=loadPage" method="POST" styleId="msgBack" >
                                </html:form>    
                                
                            
                            <ul id="holder">    
                            <logic:iterate id="assgEvaluateMstList" name="EvaluateAssgForm" property="assgEvaluateMstList">
                                <li style="width:915px">
                                <html:form action="/EvaluateAssignment.do?callmethod=submitRemarks" method="post" >
                                <div class="span6">
                                ...
                                <div>
                                <dt>Subject</dt>
                                <dd><bean:write name="EvaluateAssgForm" property="assgSubject" /></dd>
                                </div>
                                
                                <div>
                                <dt>Details</dt>
                                <dd><bean:write name="EvaluateAssgForm" property="assgDetails" /></dd>
                                </div>
                                
                                <dt>Obtained Marks</dt>
                                <dd>        
                                <bean:write name="assgEvaluateMstList" property="assgEvaluatedMarks" />&nbsp; Out Of &nbsp;<bean:write name="assgEvaluateMstList" property="assgTotalMarks" />
                                </dd>
                                <br/>
                                <html:link page="/EvaluateAssignmentStudent.do?callmethod=download" >
                                            <html:param  name="assgEvalId">
                                            <bean:write name="assgEvaluateMstList" property="assgEvalId" />
                                            </html:param>
                                            Export As PDF <i class="icon-download-alt" ></i>
                                </html:link>
...
<script type="text/javascript" src="script/GD/editGroups.js"></script>
